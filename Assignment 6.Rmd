...
location <- data.frame(lat=c(50.835869,50.830540,50.834467,50.830161, 50.829036),
                    lon=c(-4.553962,-4.551365,-4.552814,-4.544088, -4.548769),
                    area=c("Crooklets Beach","Summerleaze Beach","Cricket Club","Bar 35","Castle Bude"))
